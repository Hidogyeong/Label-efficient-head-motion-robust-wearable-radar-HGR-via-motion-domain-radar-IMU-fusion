...
txt_file_path = "E:/dokyeong/IMU_rawdata/csv/junh/"
output_directory = "E:/dokyeong/IMUData/junh/"
radar_data_directory = "E:/dokyeong/Radar_RDAData/junh/"

csv_files = glob.glob(os.path.join(radar_data_directory, '**', '*.csv'), recursive=True)
txt_files = glob.glob(os.path.join(txt_file_path, '*.csv'))
...
for txt_file in txt_files:
    ...
    for csv_file in csv_files:
        ...
        if not filtered_data.empty:
            ...
            output_file_path = os.path.join(output_directory, os.path.dirname(relative_path), output_file_name)

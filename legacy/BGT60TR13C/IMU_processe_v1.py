...
txt_file_path = "E:/dokyeong/IMU_rawdata/txt/dk/02LtoR/"
csv_output_directory = "E:/dokyeong/IMU_rawdata/csv/dk/02LtoR/"
final_output_directory = "E:/dokyeong/IMUData/dk/02LtoR/"
radar_data_directory = "E:/dokyeong/Radar_RDAData/dk/02LtoR/"
...
for txt_file in txt_files:
    ...
    # 상대 경로를 기반으로 동일한 구조를 유지하면서 CSV 파일 저장
...
txt_files = glob.glob(os.path.join(csv_output_directory, '**', '*.csv'), recursive=True)
